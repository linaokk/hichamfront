    ...
    <div className="home">
      ...
      <div className="plans">
        ...
        <div className="plan">
          ...
          <a href="#premium" className="btn btn-primary btn-lg">
            Start
          </a>
        ...
        <div className="plan">
          ...
          <a href="#business" className="btn btn-primary btn-lg">
            Start
          </a>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-left">
              <h2>Footer Title</h2>
              <p>Footer description goes here. You can add any additional information in this section.</p>
            </div>
